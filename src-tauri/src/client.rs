...
use async_openai::{
    ...
    types::{
        ...
        CreateChatCompletionResponse, ReasoningEffort, ResponseFormat,
    },
    Client,
};
...
use crate::{
    ...
    models::{OddsRange, PredictResponse, RequestsInfo, Settings, TestResults},
    utils::{get_response_format_json_schema, process_test_results},
    MongoDogInfoRepo,
};
    ...
    pub async fn send(
        ...
        let request = CreateChatCompletionRequestArgs::default()
            ...
            .response_format(ResponseFormat::JsonSchema {
                json_schema: get_response_format_json_schema(),
            })
